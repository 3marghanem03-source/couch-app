...
class AppLocalizations {
  ...
  static const Map<String, String> _en = {
    ...
    'coach.schedule.clientBookingSwitch': 'Clients can book this day',
    'coach.schedule.clientBookingSwitchHint':
        'Turn off to close the whole day — clients will not see any slots. Your time blocks still apply when open.',
    'client.home': 'Home',
    ...
    'client.book.dayClosedByCoach': 'The coach is not taking bookings on this day.',
  ...
  static const Map<String, String> _ar = {
    ...
    'coach.schedule.clientBookingSwitch': 'العملاء يمكنهم الحجز في هذا اليوم',
    'coach.schedule.clientBookingSwitchHint':
        'أطفئ لإغلاق اليوم بالكامل — لن يرى العملاء أي أوقات. عند الفتح تبقى قواعد المنع كما هي.',
    ...
    'client.book.dayClosedByCoach': 'الكوتش لا يستقبل حجوزات في هذا اليوم.',
